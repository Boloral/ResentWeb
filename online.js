(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["http://localhost:9118/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('http://localhost:9118', function() {});
    }, true);
  }
  ...
  function rchRun(json, call) {
    if (typeof signalR == 'undefined') {
      Lampa.Utils.putScript(["http://localhost:9118/signalr-6.0.25_es5.js"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('http://localhost:9118/lite/withsearch'), function(json) {
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('http://localhost:9118/player-inner/' + element.url);
      return;
    }
